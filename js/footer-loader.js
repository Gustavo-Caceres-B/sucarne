  ...
  mount.innerHTML = `
    <footer class="main-footer">
      ...
      <div class="footer-bottom-row">
        <p class="footer-copy-global">&copy; ${new Date().getFullYear()} SUCARNE. Todos los derechos reservados. <span class="footer-copy-sep">&middot;</span><span class="footer-copy-sistemas">&copy; Sucarne Sistemas V1.5.5</span></p>
