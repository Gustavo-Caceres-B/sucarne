            ...
            for(int x=0; x<bmp.Width; x++) {
                if(mask[x,y] && !visited[x,y]) {
                    ...
                    while(q.Count > 0) {
                        ...
                        // Use a 30-pixel radius to join disconnected characters in the same logo!
                    ...
                    // Filter out the "Nuestras marcas" text which is small, and any noise
...
[ScannerPro]::ScanAndCrop("c:\sucarne\assets\images\logos\marcas_grid_transparente.png", "c:\sucarne\assets\images\logos")
Write-Host "Auto-scan and crop V2 complete!"
